...
const About = () => {
  return (
    <Box bg="gray.50" minH="100vh">
      ...
      <Box
        bgGradient={{
          base: "linear(to-b, white, blue.50)",
          md: "linear(to-r, white, blue.50)",
        }}
      >
        <Container
          maxW="7xl"
        ...
        >
          <VStack align="start" gap={6}>
            ...
            <Heading size="2xl" color="blue.800">
              Vi förenklar emballage för företag
            </Heading>
            <Text
              ...
              maxW="3xl"
            >
              Star Pack levererar smarta, hållbara och prisvärda
              förpackningslösningar för företag i hela Norden. Vi fokuserar på
              kvalitet, service och snabb leverans.
            </Text>
          </VStack>
        </Container>
      </Box>
        ...
        >
          <SimpleGrid columns={{ base: 1, md: 2 }} gap={12} alignItems="center">
            <VStack align="start" gap={5}>
              ...
              <Text color="gray.700">
                Vi startade med en enkel idé: att göra det lättare för företag
                att få rätt emballage, i rätt tid. Sedan dess har vi hjälpt
                hundratals kunder att effektivisera sin packning och sänka sina
                kostnader.
              </Text>
              <Box
                as="ul"
              ...
              >
                <Box as="li" mb={1}>
                  Snabb leverans och pålitlig service
                </Box>
                <Box as="li" mb={1}>
                  Grossistpriser och brett sortiment
                </Box>
